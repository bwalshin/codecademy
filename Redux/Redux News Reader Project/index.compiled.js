(function () {
				...
				(function (process, global) {
					(function () {
						(function (global, factory) {
							typeof exports === 'object' && typeof module !== 'undefined'
								...
								: ((global =
										typeof globalThis !== 'undefined'
											? globalThis
											: global || self),
								  factory((global.MockServiceWorker = {})));
							...
							var Headers_1 = createCommonjsModule(function (module, exports) {
								...
								var Headers = /** @class */ (function () {
									...
									Headers.prototype.set = function (name, value) {
										this.map[this.normalizeName(name)] =
									...
									Headers.prototype.normalizeName = function (name) {
										...
										if (
											HEADERS_INVALID_CHARACTERS.test(name) ||
											name.trim() === ''
										) {
											throw new TypeError(
							...
							var headersToList_1 = createCommonjsModule(function (
								module,
								exports
							) {
								Object.defineProperty(exports, '__esModule', { value: true });
							...
							var headersToObject_1 = createCommonjsModule(function (
								module,
								exports
							) {
								Object.defineProperty(exports, '__esModule', { value: true });
							...
							var stringToHeaders_1 = createCommonjsModule(function (
								module,
								exports
							) {
								Object.defineProperty(exports, '__esModule', { value: true });
							...
							var listToHeaders_1 = createCommonjsModule(function (
								module,
								exports
							) {
								Object.defineProperty(exports, '__esModule', { value: true });
							...
							var reduceHeadersObject_1 = createCommonjsModule(function (
								module,
								exports
							) {
								Object.defineProperty(exports, '__esModule', { value: true });
							...
							var objectToHeaders_1 = createCommonjsModule(function (
								module,
								exports
							) {
								Object.defineProperty(exports, '__esModule', { value: true });
							...
							var flattenHeadersList_1 = createCommonjsModule(function (
								module,
								exports
							) {
								Object.defineProperty(exports, '__esModule', { value: true });
							...
							var flattenHeadersObject_1 = createCommonjsModule(function (
								module,
								exports
							) {
								Object.defineProperty(exports, '__esModule', { value: true });
							...
							const getRandomServerResponseTime = () => {
								...
								return Math.floor(
									Math.random() *
										(MAX_SERVER_RESPONSE_TIME - MIN_SERVER_RESPONSE_TIME) +
  ...
  ***************************************************************************** */
							 ...
							 */
							const getWorkerInstance = (url, options = {}, findWorker) =>
								__awaiter(void 0, void 0, void 0, function* () {
									// Resolve the absolute Service Worker URL.
									const absoluteWorkerUrl = getAbsoluteWorkerUrl(url);
									const [, mockRegistrations] = yield lib$1.until(() =>
										__awaiter(void 0, void 0, void 0, function* () {
											const registrations =
									...
									const [error, instance] = yield lib$1.until(() =>
										__awaiter(void 0, void 0, void 0, function* () {
											const registration =
												yield navigator.serviceWorker.register(url, options);
											return [
...
Learn more about creating the Service Worker script: https://mswjs.io/docs/cli/init`);
							...
							const activateMocking = (context, options) =>
								__awaiter(void 0, void 0, void 0, function* () {
									var _a;
									(_a = context.worker) === null || _a === void 0
										? void 0
										: _a.postMessage('MOCK_ACTIVATE');
							...
							const stringifyJsonBody = (res) => {
								...
								if (
									res.body &&
									((_b =
										(_a = res.headers) === null || _a === void 0
											? void 0
											: _a.get('content-type')) === null || _b === void 0
										? void 0
										: _b.endsWith('json'))
								) {
							...
							const defaultResponseTransformers = [stringifyJsonBody];
							function createResponseComposition(
								responseOverrides,
								defaultTransformers = defaultResponseTransformers
							) {
								return (...transformers) => {
							 ...
							 */
							const getResponse = (req, handlers) =>
								__awaiter(void 0, void 0, void 0, function* () {
									...
									const {
										...
										mockedResponse,
										publicRequest,
									} = yield relevantHandlers.reduce(
										(asyncAcc, [requestHandler, parsedRequest]) =>
											__awaiter(void 0, void 0, void 0, function* () {
												...
												const { getPublicRequest, defineContext, resolver } =
													requestHandler;
												...
												const context = defineContext
													...
													: defaultContext;
												const mockedResponse = yield resolver(
													publicRequest,
													response,
													context
												);
							...
							var querystring = createCommonjsModule(function (
								module,
								exports
							) {
								...
								if (body) {
									...
									const hasJsonContent =
										(_a =
											headers === null || headers === void 0
												? void 0
												: headers.get('content-type')) === null || _a === void 0
											? void 0
											: _a.includes('json');
									...
									__awaiter(void 0, void 0, void 0, function* () {
										...
										try {
											...
											const {
												...
												publicRequest,
												parsedRequest,
											} = yield getResponse(req, context.requestHandlers);
											...
											const responseWithSerializedHeaders = Object.assign(
												Object.assign({}, response),
												{ headers: lib.headersToList(response.headers) }
											);
											if (!options.quiet) {
												setTimeout(() => {
													handler.log(
							...
							function requestIntegrityCheck(context, serviceWorker) {
								return __awaiter(this, void 0, void 0, function* () {
									...
									if (actualChecksum !== '65d33ca82955e1c5928aed19d1bdf3f9') {
										throw new Error(
											`Currently active Service Worker (${actualChecksum}) is behind the latest published one (${'65d33ca82955e1c5928aed19d1bdf3f9'}).`
										);
									}
								...
								return function start(options) {
									...
									const startWorkerInstance = () =>
										__awaiter(this, void 0, void 0, function* () {
											...
											const [, instance] = yield lib$1.until(() =>
												getWorkerInstance(
...
Please consider using a custom "serviceWorker.url" option to point to the actual worker script location, or a custom "findWorker" option to resolve the Service Worker registration manually. More details: https://mswjs.io/docs/api/setup-worker/start`);
											...
											const [integrityError] = yield lib$1.until(() =>
...
If this message still persists after updating, please report an issue: https://github.com/open-draft/msw/issues\
      `);
											...
											const [activationError] = yield lib$1.until(() =>
												activateMocking(context, options)
											);
											if (activationError) {
												console.error(
													'Failed to enable mocking',
													activationError
												);
												return null;
											}
							...
							const createStop = (context) => {
								...
								return function stop() {
									...
									(_a = context.worker) === null || _a === void 0
										? void 0
										: _a.postMessage('MOCK_DEACTIVATE');
									context.events.removeAllListeners();
									window.clearInterval(context.keepAliveInterval);
								};
							};
							...
							function setupWorker(...requestHandlers) {
								...
								return {
									...
									resetHandlers(...nextHandlers) {
										context.requestHandlers = resetHandlers(
											requestHandlers,
											...nextHandlers
										);
									},
							...
							var getCleanUrl_1 = createCommonjsModule(function (
								module,
								exports
							) {
								Object.defineProperty(exports, '__esModule', { value: true });
								...
								function getCleanUrl(url, isAbsolute) {
									...
									return [isAbsolute && url.origin, url.pathname]
										.filter(Boolean)
										.join('');
								}
								...
								return (mask, resolver) => {
									...
									return {
										...
										predicate(req, parsedRequest) {
											return (
												isStringEqual(method, req.method) &&
												parsedRequest.match.matches
											);
										},
										getPublicRequest(req, parsedRequest) {
...
`);
							...
							function _possibleConstructorReturn(self, call) {
								if (
									call &&
									(_typeof$1(call) === 'object' || typeof call === 'function')
								) {
									return call;
								}
								...
								function GraphQLError(
									...
									Object.defineProperties(_assertThisInitialized(_this), {
										...
										path: {
											...
											// in JSON.stringify() when not provided.
											value:
												path !== null && path !== void 0 ? path : undefined,
							...
							var Parser = /*#__PURE__*/ (function () {
								...
								_proto.parseOperationDefinition =
								...
								_proto.parseVariableDefinitions =
								...
								_proto.parseVariableDefinition =
								...
								_proto.parseFragmentDefinition =
								...
								_proto.parseTypeSystemDefinition =
								...
								_proto.peekDescription = function peekDescription() {
									return (
										...
										this.peek(TokenKind.BLOCK_STRING)
									);
								};
								/**
								...
								_proto.parseObjectTypeDefinition =
								...
								_proto.parseImplementsInterfaces =
								...
								_proto.parseUnionTypeDefinition =
								...
								_proto.parseEnumValuesDefinition =
								...
								_proto.parseInputFieldsDefinition =
								...
								_proto.parseTypeSystemExtension =
								...
								_proto.parseObjectTypeExtension =
								...
								_proto.parseUnionTypeExtension =
								...
								_proto.parseDirectiveDefinition =
								...
								_proto.parseDirectiveLocations =
							...
							function parseQuery(query, definitionOperation = 'query') {
								...
								const operationDef = ast.definitions.find((def) => {
									return (
										...
										(definitionOperation === 'all' ||
											def.operation === definitionOperation)
									);
								});
								return {
									operationType:
										operationDef === null || operationDef === void 0
											? void 0
									...
									operationName:
										(_a =
											operationDef === null || operationDef === void 0
												? void 0
												: operationDef.name) === null || _a === void 0
											? void 0
											: _a.value,
								};
							}
							...
							const graphql = Object.assign(
								Object.assign({}, graphqlStandardHandlers),
		...
		4: [
			function (require, module, exports) {
				...
				var _ArticlePreviews = _interopRequireDefault(
					require('../features/articlePreviews/ArticlePreviews')
				);

				var _CurrentArticle = _interopRequireDefault(
					require('../features/currentArticle/CurrentArticle')
				);

				var _Comments = _interopRequireDefault(
					require('../features/comments/Comments')
				);
			...
			{
				'../features/articlePreviews/ArticlePreviews': 11,
				'../features/comments/Comments': 13,
				'../features/currentArticle/CurrentArticle': 15,
				react: undefined,
			},
		],
		5: [
			function (require, module, exports) {
				...
				var _articlePreviewsSlice = _interopRequireDefault(
					require('../features/articlePreviews/articlePreviewsSlice')
				);

				var _currentArticleSlice = _interopRequireDefault(
					require('../features/currentArticle/currentArticleSlice')
				);
			...
			{
				'../features/articlePreviews/articlePreviewsSlice': 12,
				'../features/comments/commentsSlice': 14,
				'../features/currentArticle/currentArticleSlice': 16,
		...
		11: [
			function (require, module, exports) {
				...
				var _ArticleListItem = _interopRequireDefault(
					require('../../components/ArticleListItem')
				);
				...
				var ArticlePreviews = function ArticlePreviews() {
					var dispatch = (0, _reactRedux.useDispatch)();
					var articlePreviews = (0, _reactRedux.useSelector)(
						_articlePreviewsSlice.selectAllPreviews
					);
					var isLoadingPreviews = (0, _reactRedux.useSelector)(
						_articlePreviewsSlice.isLoading
					);
					(0, _react.useEffect)(
						function () {
					...
					return /*#__PURE__*/ _react['default'].createElement(
						...
						/*#__PURE__*/ _react['default'].createElement(
							...
							articlePreviews.map(function (article) {
								return /*#__PURE__*/ _react['default'].createElement(
									'div',
									{
										key: article.id,
										onClick: function onClick(e) {
											return dispatch(
												(0, _currentArticleSlice.loadCurrentArticle)(article.id)
											);
										},
									},
									/*#__PURE__*/ _react['default'].createElement(
										_ArticleListItem['default'],
										{
											article: article,
										}
									)
			...
			{
				'../../components/ArticleListItem': 6,
				'../currentArticle/currentArticleSlice': 16,
				'./articlePreviewsSlice': 12,
				react: undefined,
				'react-redux': undefined,
			},
		],
		12: [
			function (require, module, exports) {
				...
				exports['default'] =
					exports.isLoading =
					exports.selectAllPreviews =
					exports.articlePreviewsSlice =
					exports.loadAllPreviews =
						void 0;
				...
				var loadAllPreviews = (0, _toolkit.createAsyncThunk)(
				...
				var articlePreviewsSlice = (0, _toolkit.createSlice)({
					...
					extraReducers: function extraReducers(builder) {
						builder
							.addCase(loadAllPreviews.pending, function (state) {
		...
		13: [
			function (require, module, exports) {
				...
				var _CommentList = _interopRequireDefault(
					require('../../components/CommentList')
				);

				var _CommentForm = _interopRequireDefault(
				...
				var Comments = function Comments() {
					var dispatch = (0, _reactRedux.useDispatch)();
					var article = (0, _reactRedux.useSelector)(
						_currentArticleSlice.selectCurrentArticle
					); // Declare additional selected data here.

					var comments = (0, _reactRedux.useSelector)(
						_commentsSlice.selectComments
					);
					var commentsAreLoading = (0, _reactRedux.useSelector)(
						_commentsSlice.isLoadingComments
					...
					(0, _react.useEffect)(
						function () {
							if (article !== undefined) {
								dispatch(
									(0, _commentsSlice.loadCommentsForArticleId)(article.id)
								);
							}
						},
						[dispatch, article]
					);
					var commentsForArticleId =
			...
			{
				'../../components/CommentForm': 8,
				'../../components/CommentList': 9,
				'../comments/commentsSlice': 14,
				'../currentArticle/currentArticleSlice': 16,
				react: undefined,
				'react-redux': undefined,
			},
		...
		14: [
			function (require, module, exports) {
				...
				exports['default'] =
					exports.createCommentIsPending =
					exports.isLoadingComments =
					exports.selectComments =
					exports.commentsSlice =
					exports.loadCommentsForArticleId =
						void 0;
				...
				var loadCommentsForArticleId = (0, _toolkit.createAsyncThunk)(
				...
				var commentsSlice = (0, _toolkit.createSlice)({
					...
					extraReducers: function extraReducers(builder) {
						builder
							.addCase(loadCommentsForArticleId.pending, function (state) {
								state.isLoadingComments = true;
								state.failedToLoadComments = false;
							})
							.addCase(
								loadCommentsForArticleId.fulfilled,
							...
							.addCase(
								loadCommentsForArticleId.rejected,
								function (state, action) {
									state.isLoadingComments = false;
		...
		15: [
			function (require, module, exports) {
				...
				var _FullArticle = _interopRequireDefault(
					require('../../components/FullArticle')
				);
				...
				var CurrentArticle = function CurrentArticle() {
					...
					var currentArticleIsLoading = (0, _reactRedux.useSelector)(
						_currentArticleSlice.isLoadingCurrentArticle
					);
		...
		16: [
			function (require, module, exports) {
				...
				exports['default'] =
					exports.isLoadingCurrentArticle =
					exports.selectCurrentArticle =
					exports.currentArticleSlice =
					exports.loadCurrentArticle =
						void 0;
				...
				var loadCurrentArticle = (0, _toolkit.createAsyncThunk)(
				...
				var currentArticleSlice = (0, _toolkit.createSlice)({
					...
					extraReducers: function extraReducers(builder) {
						builder
							.addCase(loadCurrentArticle.pending, function (state) {
				...
				module.exports = [
					{
						...
						fullText:
							'Joseph Robinette Biden Jr. and Kamala Devi Harris took the oath of office at a Capitol still reeling from the attack of a violent mob at a time when a deadly pandemic is still ravaging the country.',
						image:
							'https://static01.nyt.com/images/2021/01/20/us/politics/20dc-biden1-sub3/20dc-biden1-sub3-facebookJumbo.jpg',
					},
					{
						id: 2,
						...
						fullText:
							'LG says it needs to make "a cold judgment" about its only money-losing division.',
						image:
							'https://cdn.arstechnica.net/wp-content/uploads/2021/01/37-760x380.jpg',
					},
					{
						id: 3,
						...
						fullText:
							'TVW CEO Herbert Diess is poking fun at his friendly rivalry with Tesla CEO Elon Musk in his Twitter debut as he tries to position Volkswagen as a leader in electrification.',
						image:
							'https://i1.wp.com/electrek.co/wp-content/uploads/sites/3/2020/09/VW-CEO-Hebert-Diess-Tesla-CEO-Elon-Musk-selfie-hero.jpg?resize=1200%2C628&quality=82&strip=all&ssl=1',
					},
					{
						id: 4,
						...
						fullText:
							'As President Biden took office, some QAnon believers tried to rejigger their theories to accommodate a transfer of power.',
						image:
							'https://static01.nyt.com/images/2021/01/20/business/20distortions-qanon/20distortions-qanon-facebookJumbo.jpg',
					},
					{
						id: 5,
						...
						fullText:
							'Harris becomes the first woman, Black woman and Asian American to serve as vice president.',
						image:
							'https://www.washingtonpost.com/wp-apps/imrs.php?src=https://arc-anglerfish-washpost-prod-washpost.s3.amazonaws.com/public/H4TGAGS3IEI6XKCJN6KCHJ277U.jpg&w=1440',
					},
					{
						id: 6,
						title:
						...
						fullText:
							"Elon Musk's company is now offering early public access to its Starlink satellite internet service in Canada and the U.K.",
						image:
							'https://image.cnbcfm.com/api/v1/image/106758975-1603465968180-EkzQ0UbXgAAGYVe-orig.jpg?v=1603466027',
					},
					{
						id: 7,
						...
						fullText:
							'Experts, long puzzled by how butterflies fly, have found that the insects "clap" their wings together -- and their wings are perfectly evolved for better propulsion.',
						image:
							'https://cdn.cnn.com/cnnnext/dam/assets/210120064324-restricted-butterflies-clap-intl-scli-super-tease.jpg',
					},
					{
						id: 8,
						title:
						...
						fullText:
							"Even locked up in a detention center on the outskirts of Moscow, Kremlin critic Alexey Navalny continues to be a thorn in Russian President Vladimir Putin's side.",
						image:
							'https://cdn.cnn.com/cnnnext/dam/assets/210120111237-restricted-05-putin-palace-navalny-russia-intl-super-tease.jpeg',
					},
				];
			},
			{},
		...
		19: [
			function (require, module, exports) {
				...
				var worker = _msw.setupWorker.apply(
					void 0,
					_toConsumableArray(_handlers.handlers)
				);
		...
		21: [
			function (require, module, exports) {
				...
				var handlers = [
					_msw.rest.get('/api/articles', function (req, res, ctx) {
						mockDelay(500);
						return res(
							ctx.status(200),
							ctx.json(
								_articles['default'].map(function (article) {
									return {
										id: article.id,
										title: article.title,
					...
					_msw.rest.get('/api/articles/:articleId', function (req, res, ctx) {
						...
						return res(
							ctx.status(200),
							ctx.json(
								_articles['default'].find(function (article) {
			...
			{ './articles.json': 18, './comments.json': 20, msw: 1 },
		],
	},
	{},
	[17]
