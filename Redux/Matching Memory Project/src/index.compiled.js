(function () {
...
})()(
  {
    ...
    2: [
      function (require, module, exports) {
        ...
        var App = function App() {
          ...
          return /*#__PURE__*/ _react["default"].createElement(
            ...
            /*#__PURE__*/ _react["default"].createElement(_Score.Score, null),
            /*#__PURE__*/ _react["default"].createElement(_Board.Board, null),
      ...
      {
        "./App.css": 1,
        "./features/board/Board.js": 4,
        "./features/score/Score.js": 8,
        react: undefined,
      },
    ],
    3: [
      ...
      { "../features/board/boardSlice.js": 5, redux: undefined },
    ],
    4: [
      function (require, module, exports) {
        "use strict";
        ...
        var Board = function Board() {
          ...
          var currentBoard = (0, _reactRedux.useSelector)(
            _boardSlice.selectBoard
          );
          ...
          for (var row = 0; row < rows; row++) {
            ...
            content.push(
              /*#__PURE__*/ _react["default"].createElement(_CardRow.CardRow, {
                key: row,
                cards: rowCards,
              })
            );
        ...
        var boardReducer = function boardReducer() {
          ...
          switch (action.type) {
            ...
            case "board/flipCard":
              ...
              flipState[cardID] = _objectSpread(
                _objectSpread({}, state[cardID]),
                {},
                {
                  visible: true,
                }
              ...
              var _flipState$filter$map = flipState
                ...
                _flipState$filter$map2 = _slicedToArray(
                  _flipState$filter$map,
                  2
                ),
              ...
              if (index2 !== undefined) {
                ...
                if (card1.contents === card2.contents) {
                  flipState[index1] = _objectSpread(
                    _objectSpread({}, card1),
                    {},
                    {
                      visible: false,
                  ...
                  flipState[index2] = _objectSpread(
                    _objectSpread({}, card2),
                    {},
                    {
                      visible: false,
    ...
    6: [
      ...
      { "./card/Card.js": 7, react: undefined },
    ],
    7: [
      function (require, module, exports) {
        "use strict";
        ...
        var Card = function Card(_ref) {
          ...
          var visibleIDs = (0, _reactRedux.useSelector)(
            _boardSlice.selectVisibleIDs
          ); // flip card action
      ...
      { "../../boardSlice.js": 5, react: undefined, "react-redux": undefined },
    ],
    8: [
      function (require, module, exports) {
        "use strict";
